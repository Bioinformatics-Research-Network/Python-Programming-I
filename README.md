...
[![](https://img.shields.io/static/v1?label=Classroom&message=Launch&color=blue&logo=GitHub)](https://classroom.github.com/a/aCew8-kG)
![](https://img.shields.io/static/v1?label=Version&message=0.0.1a&color=green)

**Purpose**: This skill assessment will test your fundamental Python programming skills. 

**Pre-requisites**: None

## Background

To complete this skill assessment, you will need to launch it in GitHub classroom by clicking the badge above or following [this link](https://classroom.github.com/a/aCew8-kG). For further information on how to complete BRN skill assessments, visit our tutorial [here](www.google.com).
...
3. To lint your code locally, run `flake8` from the command line
    ...
    - To style your code automatically, run `black` from the command line
...
The BIG workshop on Python programming & ML ([link](https://www.bigbioinformatics.org/copy-of-r-for-biologists)), DataCamp's introductory Python course ([link](https://www.datacamp.com/courses/intro-to-python-for-data-science)), and intermediate Python course ([link](https://www.datacamp.com/courses/intermediate-python)).
...
**Premise**: You are a new bioinformatics programmer in a population genomics laboratory studying the relationship between gene mutations and cancer progression. The senior bioinformatician needs your help analyzing mutations found in the tumors of breast cancer patients. She asks you to **write a Python script** named `utils.py` which contains functions needed for the analysis. 

The following tasks describe the functions that should be included in `utils.py`.
